    ...
    'columns' => [
        ...
        'type' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'items' => [
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_be_users', \Mirko\Newsletter\Domain\Model\RecipientList\BeUsers::class],
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_fe_groups', \Mirko\Newsletter\Domain\Model\RecipientList\FeGroups::class],
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_fe_pages', \Mirko\Newsletter\Domain\Model\RecipientList\FePages::class],
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_sql', \Mirko\Newsletter\Domain\Model\RecipientList\Sql::class],
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_csv_file', \Mirko\Newsletter\Domain\Model\RecipientList\CsvFile::class],
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_csv_list', \Mirko\Newsletter\Domain\Model\RecipientList\CsvList::class],
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_csv_url', \Mirko\Newsletter\Domain\Model\RecipientList\CsvUrl::class],
                    ['LLL:EXT:newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_html', \Mirko\Newsletter\Domain\Model\RecipientList\Html::class],
                ],
                'maxitems' => 1,
