(function () {
     ...
     */
    Ext.ux.Mirko.Newsletter.Store.Recipient = (function () {
        ...
        var initialize = function () {
            if (selectedRecipientListStore === null) {
                selectedRecipientListStore = new Ext.data.DirectStore({
                    storeId: 'Mirko\\Newsletter\\Domain\\Model\\Recipient',
                    ...
                    api: {
                        read: Ext.ux.Mirko.Newsletter.Remote.RecipientListController.listRecipientAction,
                    },
                    paramOrder: {
